...
<div class="custom-post-thumbnails">
    ...
    <div class="thumbnail-container-accueil">
        ...
        $args_custom_posts = array(
            'post_type' => 'photos',          // Type de publication personnalisée (photo) 
                ...
                <div class="thumbnail-wrapper">
                    <a href="<?php the_permalink(); ?>">
                        ...
                        <div class="thumbnail-overlay">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/icon_eye.png" alt="Icône de l'œil"> <!-- Icône de l'œil -->
                            ...
                            <!-- Overlay | Affiche la Référence et les Catégories de l'image associée au survol -->
